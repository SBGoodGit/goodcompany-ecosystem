...
Then I told my aunt about it. She was Head of HR at ING Global at the time. She liked the concept but pointed out a real problem: anti-discrimination law in the Netherlands means recruiters cannot see who a candidate is at early stages. My reaction was that bias can enter at any point in a hiring process anyway — so the law doesn't really solve the problem. She agreed. But governments had decided, and that was that. It took the wind out of my sails.
